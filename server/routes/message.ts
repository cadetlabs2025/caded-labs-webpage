...
export const handleMessage: RequestHandler = async (req, res) => {
  try {
    const formData: MessageRequest = req.body;
...
Submitted: ${new Date().toLocaleString()}
    ...
    if (process.env.SENDGRID_API_KEY) {
      ...
      console.log("⚠️ SendGrid not configured. Logging contact form message:");
...
function formatEmailHTML(data: MessageRequest, fullName: string): string {
  return `
    <!DOCTYPE html>
    <html>
    <head>
